      ...
      <aside className="flex items-center gap-5">
        ...
        <section className="space-y-2">
          ...
          <div className="flex items-center gap-7 font-semibold">
            <span  className="text-green-500 flex items-center gap-1"><FaDownload /> {downloads}</span>
            <span className="text-amber-500 flex items-center gap-1"><FaStar /> {ratingAvg}</span>
            <span className="text-gray-600 flex items-center gap-1"> {size} MB</span>
          </div>
        </section>
      </aside>
